...
function cleanWikiHtml(html: string): string {
  ...
  // Fix image URLs to use wiki CDN
  cleaned = cleaned.replace(/src="\/images\//g, 'src="https://es.minecraft.wiki/images/')
  cleaned = cleaned.replace(/src="\/\/es\.minecraft\.wiki/g, 'src="https://es.minecraft.wiki')
  ...
  cleaned = cleaned.replace(/<a([^>]*?)href="https?:\/\//g, '<a$1target="_blank" rel="noopener noreferrer" href="https://')
                                      ...
                                      {expandedSections.has(section.index) && (
                                        <div className="px-4 py-3 border-t border-[rgba(255,255,255,0.06)] bg-[#07070b]">
                                          {sectionContents[section.index] ? (
                                            <div 
                                              className="wiki-rendered-content prose prose-invert prose-sm max-w-none"
