...
export default function PlayerPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none diagonal-bg opacity-90" aria-hidden />
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <div className="diagonal-bg-orb-a" />
        <div className="diagonal-bg-orb-b" />
        <div className="diagonal-bg-orb-c" />
      </div>
      ...
      <div className="relative pt-20">
        <div className="relative h-72 sm:h-80 overflow-hidden">
          {/* Skin-based blurred backdrop (subtle, slow ken-burns drift) */}
          <div
          ...
          <div className="profile-bg" aria-hidden>
            <div className="profile-bg-aurora-1" />
            <div className="profile-bg-aurora-2" />
            <div className="profile-bg-aurora-3" />
            <div className="profile-bg-grid" />
            <div className="profile-bg-shimmer" />
            {/* Floating particles */}
            {[
              { left: '8%', delay: '0s', dur: '11s', size: 3 },
              { left: '17%', delay: '2.5s', dur: '13s', size: 4 },
              { left: '28%', delay: '1s', dur: '9s', size: 2 },
              { left: '38%', delay: '4s', dur: '14s', size: 3 },
              { left: '49%', delay: '0.8s', dur: '10s', size: 4 },
              { left: '58%', delay: '3s', dur: '12s', size: 2 },
              { left: '67%', delay: '5s', dur: '15s', size: 3 },
              { left: '76%', delay: '1.8s', dur: '11s', size: 4 },
              { left: '85%', delay: '3.6s', dur: '13s', size: 2 },
              { left: '93%', delay: '0.4s', dur: '10s', size: 3 },
            ].map((p, i) => (
              <span
                key={i}
                className="profile-bg-particle"
                style={{
                  left: p.left,
                  width: p.size,
                  height: p.size,
