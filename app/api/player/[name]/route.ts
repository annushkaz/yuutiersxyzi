...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      name: profile.name,
      skin: {
        url: skinUrl || `https://crafatar.com/skins/${cleanUuid}`,
        variant: skinVariant,
      },
      ...
      nameHistory,
      renders: {
        avatar: `https://mc-heads.net/avatar/${cleanUuid}/256`,
        head: `https://mc-heads.net/head/${cleanUuid}/256`,
        body: `https://mc-heads.net/body/${cleanUuid}/256`,
      },
    }, {
      headers: {
