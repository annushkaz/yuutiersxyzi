...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/api/players', label: 'Player endpoints' },
      { href: '/docs/api/skins', label: 'Skin endpoints' },
      { href: '/docs/api/servers', label: 'Server endpoint' },
      { href: '/docs/api/news', label: 'News endpoint' },
